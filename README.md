...
Instructions: CLAUDE.md files in your workspace root, .claude/CLAUDE.md, and ~/.claude/CLAUDE.md. VS Code also reads instruction files from the .claude/rules folder. See Custom Instructions for details.
Agents: .md files in the .claude/agents folder, following the Claude sub-agents format. See Custom agent file locations for details.
Skills: Skill definitions in .claude/skills and ~/.claude/skills folders. See Agent Skills for details.
Hooks: Hook configurations in .claude/settings.json and ~/.claude/settings.json. See Agent hooks for details.
...
If you'd like to read release notes for previous VS Code versions, go to Updates
